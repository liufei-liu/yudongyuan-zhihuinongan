...
function searchDevices(address) {  
    ...
    var button1 = document.getElementById('searchDevicesbtn');  
    ...
    receiver = plus.android.implements('io.dcloud.android.content.BroadcastReceiver', {  	
        onReceive: function(context, intent) { //实现onReceiver回调函数  
			...
			//  	},
			//  	fail: function(e){
			//  		mui.toast('开始搜索失败! '+JSON.stringify(e));
            ...
            if (BleDevice.getBondState() == bdevice.BOND_NONE) {  
                ...
                //li2.innerText = un;
				li2.innerHTML = "<span>" + un + "</span>&nbsp;&nbsp;&nbsp;&nbsp;" +
				                "<span class='BTmac'>" + BleDevice.getAddress() + "</span>";
				  console.log('hello：'+li2.innerHTML);
                vlist2.appendChild(li2);}  
            }}  
...
function openBluetooth(){
	...
	plus.bluetooth.openBluetoothAdapter({
		...
		fail: function(e){
			mui.toast('打开失败! '+JSON.stringify(e));
		}
	});
}
...
function startDiscovery(){
	...
	plus.bluetooth.startBluetoothDevicesDiscovery({
		...
		fail: function(e){
			mui.toast('初始化蓝牙失败! '+JSON.stringify(e));
		}
	});
